    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <ChevronDownIcon
          ...
          className="pointer-events-none shrink-0 text-white group-aria-expanded/accordion-trigger:hidden"
        />
        <ChevronUpIcon
          color="white"
          data-slot="accordion-trigger-icon"
          className="pointer-events-none hidden shrink-0 text-white group-aria-expanded/accordion-trigger:inline"
        />
      </AccordionPrimitive.Trigger>
